import { $ as createTextVNode, $n as toRefs, At as onBeforeMount, Bt as onUpdated, C as vShow, Cn as withDirectives, Dt as mergeProps, Ft as onMounted, Gn as readonly, Kn as ref, M as Fragment, Mn as effectScope, Mt as onBeforeUpdate, Ot as nextTick, Qn as toRef, S as vModelText, T as withModifiers, U as computed, Ut as provide, Vn as onScopeDispose, W as createBaseVNode, Wn as reactive, Yn as shallowRef, Zn as toRaw, _n as watchEffect, ar as normalizeClass, cn as useId, cr as toDisplayString, er as toValue, et as createVNode, ft as guardReactiveProps, gn as watch, ir as capitalize, jt as onBeforeUnmount, n as Transition, or as normalizeProps, pt as h, sr as normalizeStyle, tr as triggerRef, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-bxHPzvsr.js";
import { $ as omit, B as humanReadableFileSize, G as isObject, I as getObjectValueByPath, J as keyValues, K as isOn, L as getPropertyFromItem, N as getDecimals, O as filterInputAttrs, P as getEventCoordinates, Q as noop, R as has, T as escapeForRegex, U as isComposingIgnoreKey, W as isEmpty, Y as keys, Z as mergeDeep, _ as clamp, _t as consoleError, at as refElement, b as debounce, bt as propsFactory, c as getCurrentInstance, d as EventProp, f as callEvent, ft as PREFERS_REDUCED_MOTION, g as chunkArray, ht as SUPPORTS_MATCH_MEDIA, it as pickWithRest, lt as wrapInArray, m as checkPrintable, n as defineFunctionalComponent, o as provideDefaults, ot as renderSlot, pt as SUPPORTS_EYE_DROPPER, q as isPrimitive, r as genericComponent, rt as pick, st as templateRef, t as defineComponent, u as CircularBuffer, ut as IN_BROWSER, v as convertToUnit, vt as consoleWarn, w as ensureValidVNode, x as deepToRaw, y as createRange, yt as deprecate } from "./defineComponent-DJMAWlJE.js";
import { n as makeComponentProps, t as useRender } from "./useRender-HuBTQQoT.js";
import { a as makeVariantProps, c as useDensity, d as makeBorderProps, f as useBorder, i as genOverlays, l as makeLocationProps, n as makeSizeProps, o as useVariant, p as VDefaultsProvider, r as useSize, s as makeDensityProps, t as VIcon, u as useLocation, y as toPhysical } from "./VIcon-D4OBN5Vn.js";
import { a as useTheme, c as provideLocale, d as useProxiedModel, f as useToggleScope, g as getTargetBox, i as provideTheme, l as useLocale, p as Box, r as makeThemeProps, u as useRtl } from "./theme-x7b31ggL.js";
import { _ as VDialogTransition, a as VExpandXTransition, c as VScaleTransition, d as VScrollYReverseTransition, f as VScrollYTransition, g as VSlideYTransition, h as VSlideYReverseTransition, i as VExpandTransition, l as VScrollXReverseTransition, m as VSlideXTransition, n as VDialogTopTransition, o as VFabTransition, p as VSlideXReverseTransition, r as VExpandBothTransition, s as VFadeTransition, t as VDialogBottomTransition, u as VScrollXTransition, v as animate } from "./transitions-BrfAVllq.js";
import { A as VChipGroup, B as getScrollParent, C as useLazy, D as makeDelayProps, E as useFocusTrap, F as makeVCheckboxBtnProps, I as VSelectionControl, L as makeVSelectionControlProps, M as VSlideGroupSymbol, N as makeVSlideGroupProps, O as useDelay, P as VCheckboxBtn, R as VSelectionControlGroup, S as makeLazyProps, T as makeFocusTrapProps, V as getScrollParents, _ as VMenu, a as makeFilterProps, b as makeVOverlayProps, c as useScrolling, d as VVirtualScroll, f as makeVirtualProps, g as makeVSheetProps, h as VSheet, i as useMenuActivator, j as VSlideGroup, k as VChip, l as useFocusRepair, m as VVirtualScrollItem, n as VSelect, o as useFilter, p as useVirtual, r as makeSelectProps, s as useFocusGroups, t as VAutocomplete, u as VHighlight, v as makeVMenuProps, w as useHydration, x as useScopeId, y as VOverlay, z as makeSelectionControlGroupProps } from "./VAutocomplete-DyJDQhp0.js";
import { _ as parseColor, a as HSVtoRGB, c as RGBtoHSV, d as getContrast, i as HSVtoHex, n as HSVtoCSS, o as HexToHSV, r as HSVtoHSL, s as RGBtoCSS, t as HSLtoHSV } from "./colorUtils-DtTzJ43h.js";
import { _ as createSimpleFunctional, a as makeVListProps, c as transformItem$2, d as VListItem, f as makeVListItemProps, g as makeVListGroupProps, h as VListGroup, i as VList, l as useItems, m as VListItemSubtitle, n as VListItemAction, o as useListItems, p as VListItemTitle, r as VListImg, t as VListItemMedia, u as VListSubheader } from "./VList-BvlxBWk3.js";
import { a as useRouter, c as deepEqual, i as useLink, n as makeRouterProps, o as makeElevationProps, s as useElevation, t as Ripple } from "./ripple-Dq02u7Zz.js";
import { a as useTransition, i as standardEasing, r as easingPatterns } from "./easing-C2bqKIMh.js";
import { t as useResizeObserver } from "./resizeObserver-BjXI6kBQ.js";
import { a as useLayout, i as makeLayoutProps, n as createLayout, o as useLayoutItem, r as makeLayoutItemProps, t as VuetifyLayoutKey } from "./layout-D-JAexgl.js";
import { t as VApp } from "./VApp-BsiBV6Ra.js";
import { t as makeTagProps } from "./tag-lHSgxJLt.js";
import { a as VToolbarTitle, i as VToolbar, n as VAppBarNavIcon, r as VAppBar, t as VAppBarTitle } from "./VAppBar-DdBTolqr.js";
import { n as useDimension, t as makeDimensionProps } from "./dimensions-CzZ2TS3j.js";
import { n as makeVImgProps, r as VResponsive, t as VImg } from "./VImg-C84XVQop.js";
import { a as useColor, i as useBackgroundColor, n as useRounded, o as useTextColor, r as computeColor, t as makeRoundedProps } from "./rounded-xjsKGb0c.js";
import { n as MaybeTransition, r as makeTransitionProps, t as Intersect } from "./intersect-BCk4CJfc.js";
import { t as useSsrBoot } from "./ssrBoot-po3fPmGI.js";
import { a as VBtnToggleSymbol, i as VBtnToggle, n as makeVBtnProps, o as VBtnGroup, r as VProgressCircular, t as VBtn } from "./VBtn-D4Onu_Ie.js";
import { a as useLoader, c as makeGroupItemProps, d as useGroupItem, i as makeLoaderProps, l as makeGroupProps, n as usePosition, o as VProgressLinear, r as LoaderSlot, s as useIntersectionObserver, t as makePositionProps, u as useGroup } from "./position-BAGUC-xS.js";
import { a as VLigatureIcon, i as VComponentIcon, n as IconValue, o as VSvgIcon, r as VClassIcon } from "./icons-Cw_N2TAG.js";
import { n as VBadge, t as VAvatar } from "./VAvatar-XRew_DwN.js";
import { S as VLabel, _ as useForm, a as useAutocomplete, b as VMessages, c as VFieldLabel, d as VInput, f as makeVInputProps, g as makeFormProps, h as createForm, i as makeAutocompleteProps, l as VCounter, m as useValidation, n as makeVTextFieldProps, o as VField, p as makeValidationProps, r as useAutofocus, s as makeVFieldProps, t as VTextField, u as forwardRefs, v as makeFocusProps, x as useInputIcon, y as useFocus } from "./VTextField-BMNxKsdg.js";
import { a as breakpoints, c as useDisplay, s as makeDisplayProps } from "./goto-BP8snIvn.js";
import { n as makeVDividerProps, t as VDivider } from "./VDivider-Cxx4OUyG.js";
import { a as createDateRange, o as daysDiff, s as useDate, t as parseKeyCombination } from "./hotkey-parsing-BXBEiogT.js";
import { t as VMain } from "./VMain-CMtvAbPb.js";
import { t as VNumberInput } from "./VNumberInput-CgcFOUqS.js";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VAlert/VAlert.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCheckbox/VCheckbox.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTextField/VTextField.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBanner/VBanner.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBottomNavigation/VBottomNavigation.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBottomSheet/VBottomSheet.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDialog/VDialog.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBreadcrumbs/VBreadcrumbs.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/VCalendarCategory.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/VCalendarDaily.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/VCalendarWeekly.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VIconBtn/VIconBtn.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/composables/calendarWithEvents.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCard/VCard.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCarousel/VCarousel.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VWindow/VWindow.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCode/VCode.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorInput/VColorInput.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPicker.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPickerCanvas.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPickerEdit.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPickerPreview.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlider/VSlider.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlider/VSliderThumb.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlider/VSliderTrack.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPickerSwatches.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VPicker/VPicker.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCombobox/VCombobox.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTable.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableFooter.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VPagination/VPagination.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTable/VTable.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePicker.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerControls.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VGrid/VContainer.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VGrid/VGrid.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VGrid/VSpacer.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerHeader.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonth.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonths.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerYears.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VEmptyState/VEmptyState.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanel.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFab/VFab.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileInput/VFileInput.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileUpload/VFileUpload.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFooter/VFooter.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VHotkey/VHotkey.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VKbd/VKbd.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VInfiniteScroll/VInfiniteScroll.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VItemGroup/VItemGroup.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VLayout/VLayout.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VLayout/VLayoutItem.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VLocaleProvider/VLocaleProvider.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VNavigationDrawer/VNavigationDrawer.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VOtpInput/VOtpInput.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VParallax/VParallax.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VPullToRefresh/VPullToRefresh.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VRadioGroup/VRadioGroup.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VRating/VRating.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSkeletonLoader/VSkeletonLoader.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSnackbar/VSnackbar.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTooltip/VTooltip.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSpeedDial/VSpeedDial.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepper.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepperItem.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepperVertical/VStepperVerticalItem.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSwitch/VSwitch.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSystemBar/VSystemBar.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTabs/VTab.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTabs/VTabs.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTextarea/VTextarea.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VThemeProvider/VThemeProvider.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimeline/VTimeline.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/VTimePicker.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/VTimePickerClock.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/VTimePickerControls.css";
import "/Users/clement/work/oddspark-calculator/node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTreeview/VTreeviewItem.css";
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/util/events.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/util/indentLines.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VAlert/VAlertTitle.js
var VAlertTitle = createSimpleFunctional("v-alert-title");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/iconSizes.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VAlert/VAlert.js
var allowedTypes = [
	"success",
	"info",
	"warning",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCheckbox/VCheckbox.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBanner/VBannerActions.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBanner/VBannerText.js
var VBannerText = createSimpleFunctional("v-banner-text");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBanner/VBanner.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBottomNavigation/VBottomNavigation.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDialog/VDialog.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBottomSheet/VBottomSheet.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBreadcrumbs/VBreadcrumbsDivider.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBreadcrumbs/VBreadcrumbsItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VBreadcrumbs/VBreadcrumbs.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VIconBtn/VIconBtn.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/util/dateTimeUtils.js
function isLeapYear(year) {
	return year % 4 === 0 && year % 100 !== 0 || year % 400 === 0;
}
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/util/timestamp.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/composables/times.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/composables/calendarBase.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/composables/calendarWithIntervals.js
...
function useCalendarWithIntervals(props) {
	...
	const intervalFormatter = computed(() => {
		...
		const hour12 = props.format === "ampm" ? true : props.format === "24hr" ? false : void 0;
	...
	function getIntervalAtEvent(e) {
		...
		return (getTargetBox([target.clientX, target.clientY]).y - bounds.top) / parsedIntervalHeight.value;
	}
	function getTimestampAtEvent(e, day) {
		const timestamp = copyTimestamp(day);
		const addMinutes = Math.floor(getIntervalAtEvent(e) * parsedIntervalMinutes.value);
		return updateMinutes(timestamp, firstMinute.value + addMinutes, base.times.now);
	}
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/composables/intervalHighlight.js
var makeIntervalHighlightProps = propsFactory({ intervalHighlight: {
	type: [Boolean, String],
	default: false
} }, "interval-highlight");
function useIntervalHighlight(props, base) {
	const hoveredTime = shallowRef(null);
	const { textColorClasses, textColorStyles } = useTextColor(() => typeof props.intervalHighlight === "string" && props.intervalHighlight ? props.intervalHighlight : "surface-variant");
	...
	function genUnderlay() {
		if (!props.intervalHighlight) return void 0;
		return createBaseVNode("div", {
			"class": normalizeClass(["v-calendar-daily__day-interval__underlay", textColorClasses.value]),
			"style": normalizeStyle(textColorStyles.value)
		}, null);
	}
	return {
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/directives/resize/index.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/VCalendarDaily.js
var VCalendarDaily = defineComponent({
	...
	setup(props, { slots, attrs }) {
		...
		function genDayInterval(interval) {
			...
			return createBaseVNode("div", {
				"class": normalizeClass(["v-calendar-daily__day-interval", { "v-calendar-daily__day-interval--hover": highlight.isHighlighted(interval) }]),
				"key": interval.time,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/util/parser.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/VCalendarCategory.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/VCalendarWeekly.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/modes/common.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/modes/column.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/modes/stack.js
var FULL_WIDTH = 100;
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/modes/index.js
var CalendarEventOverlapModes = {
	stack,
	column
};
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/util/events.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/composables/calendarWithEvents.js
var WIDTH_FULL = 100;
var WIDTH_START = 95;
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCalendar/VCalendar.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCard/VCardActions.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCard/VCardSubtitle.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCard/VCardTitle.js
var VCardTitle = createSimpleFunctional("v-card-title");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCard/VCardItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCard/VCardText.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCard/VCard.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/directives/touch/index.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VWindow/VWindow.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCarousel/VCarousel.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VWindow/VWindowItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCarousel/VCarouselItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCode/index.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/util/index.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPickerEdit.js
...
var VColorPickerEdit = defineComponent({
	...
	setup(props, { emit }) {
		...
		useRender(() => createBaseVNode("div", {
			...
			"style": normalizeStyle(props.style)
		}, [inputs.value?.map((inputProps) => createVNode(VColorPickerInput, mergeProps(inputProps, { "label": props.hideInputLabels ? void 0 : inputProps.label }), null)), enabledModes.value.length > 1 && createVNode(VBtn, {
			"icon": "$unfold",
			"size": "x-small",
			"variant": "plain",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlider/slider.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlider/VSliderThumb.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlider/VSliderTrack.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlider/VSlider.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPickerPreview.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPickerSwatches.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VPicker/VPickerTitle.js
var VPickerTitle = createSimpleFunctional("v-picker-title");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VPicker/VPicker.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorPicker/VColorPicker.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VConfirmEdit/VConfirmEdit.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VColorInput/VColorInput.js
var availablePipLocations = [
	"prepend",
	"prepend-inner",
	"append",
	"append-inner"
...
var VColorInput = genericComponent()({
	...
	setup(props, { slots }) {
		...
		useRender(() => {
			...
			const slotWithPip = props.hidePip ? void 0 : { [props.pipLocation]: (arg) => createBaseVNode(Fragment, null, [createVNode(VAvatar, {
			...
			return createVNode(VTextField, mergeProps(textFieldProps, {
				...
				default: () => createBaseVNode(Fragment, null, [createVNode(VMenu, mergeProps({
					...
					"openOnClick": false
				}, props.menuProps), { default: () => [createVNode(VConfirmEdit, mergeProps(confirmEditProps, {
					"modelValue": model.value,
					"onUpdate:modelValue": ($event) => model.value = $event,
					"onSave": onSave,
					"onCancel": onCancel
					...
					function onUpdateModel(value) {
						if (!props.hideActions) proxyModel.value = value;
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VCombobox/VCombobox.js
...
var VCombobox = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		function onAfterLeave() {
			if (isFocused.value) if (vMenuRef.value?.contentEl?._clickOutside?.lastMousedownWasOutside) isFocused.value = false;
		...
		useRender(() => {
			...
			return createVNode(VTextField, mergeProps({ "ref": vTextFieldRef }, textFieldProps, {
				...
				default: ({ id }) => createBaseVNode(Fragment, null, [createVNode(VMenu, mergeProps({
					...
					"onAfterEnter": onAfterEnter,
					"onAfterLeave": onAfterLeave
				}, props.menuProps, { "contentClass": ["v-combobox__content", props.menuProps?.contentClass] }), { default: () => [createVNode(VSheet, {
					...
					hasList && createVNode(VList, mergeProps({
						...
						createVNode(VVirtualScroll, {
							...
							return slots.item?.({
								...
								title: () => {
									return isPristine.value ? item.title : createVNode(VHighlight, {
										"text": item.title,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/expand.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/group.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/options.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/paginate.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/select.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/sort.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataIterator/composables/items.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataIterator/VDataIterator.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/refs.js
function useRefs() {
	const refs = ref([]);
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VPagination/VPagination.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableFooter.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableColumn.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/headers.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/loading.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableHeaders.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableGroupHeaderRow.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableRow.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableRows.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTable/VTable.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/composables/items.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTable.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableVirtual.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDataTable/VDataTableServer.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VGrid/VContainer.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VGrid/VCol.js
var breakpointProps = (() => {
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VGrid/VRow.js
var ALIGNMENT = [
	"start",
	"end",
	"center"
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VGrid/VSpacer.js
var VSpacer = createSimpleFunctional("v-spacer", "div", "VSpacer");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerControls.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerHeader.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/calendar.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/virtualFocus.js
function useVirtualFocus(items, options) {
	...
	function step(stride) {
		...
		let hops = 0;
		if (circular) index = mod(all.length, index);
		else if (index < 0 || index >= all.length) return;
		while (hops < maxHops) {
	...
	function rowFirst() {
		...
		for (let i = start; i < Math.min(start + cols, all.length); i++) if (!toValue(all[i]?.disabled)) {
			go(all[i].id);
			return;
		}
	}
	function rowLast() {
		...
		for (let i = end - 1; i >= start; i--) if (!toValue(all[i]?.disabled)) {
			go(all[i].id);
			return;
		}
	}
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/gridSelection.js
...
function useGridSelection({ items, columns, initialValue, itemAttribute, onSelect, onNavigation, onHighlight, onEscape }) {
	...
	if (onHighlight) watch(virtualFocus.highlightedId, (id) => onHighlight(id));
	function onFocusin(e) {
		const grid = containerEl.value;
		if (!grid || grid.contains(e.relatedTarget)) return;
		hasFocusIn.value = true;
		const targetId = e.target?.getAttribute?.(itemAttribute);
	...
	function onActivate() {
		...
		if (item && !item.isDisabled) onSelect(id);
	}
	...
	return {
		containerProps: computed(() => ({
			ref: (el) => containerEl.value = el ?? void 0,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/rangePicker.js
function useRangePicker({ multiple, model, compare, normalizeEnd = (v) => v, previewValue: externalPreview }) {
	const rangeStart = computed(() => model.value.length >= 1 ? model.value[0] : void 0);
	const rangeEnd = computed(() => model.value.length >= 2 ? model.value[model.value.length - 1] : void 0);
	...
	function isSelected(value) {
		if (multiple.value === "range" && model.value.length === 2) return isWithinRange(value);
		for (const v of model.value) if (compare(v, value) === 0) return true;
		return false;
	}
	...
	function select(value) {
		if (multiple.value === "range") onRangeSelect(value);
		else if (multiple.value) onMultipleSelect(value);
		else model.value = [value];
	}
	function onRangeSelect(value) {
		if (model.value.length === 0) model.value = [value];
		else if (model.value.length === 1) {
			const start = model.value[0];
			if (compare(value, start) === 0) model.value = [];
			else if (compare(value, start) < 0) model.value = [value, normalizeEnd(start)];
			else model.value = [start, normalizeEnd(value)];
		} else model.value = [value];
	}
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonth.js
...
var VDatePickerMonth = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		const { backgroundColorClasses: rangeColorClasses, backgroundColorStyles: rangeColorStyles } = useBackgroundColor(toRef(() => props.color || "surface-variant"));
		...
		function initialFocusDate(current) {
			...
			return (daysInMonth.value.find((d) => isVisible(d) && model.value.some((m) => adapter.isSameDay(m, d.date))) ?? daysInMonth.value.find(isVisible))?.isoDate;
		}
		const { containerProps, containerEl, selectItem, focusItem, clear } = useGridSelection({
		...
		function onNavigationBoundary(direction, e, curId) {
			...
			e.preventDefault();
			let targetIsoDate;
			if (targetItem) targetIsoDate = targetItem.isoDate;
			else {
				const step = calendarDays < 0 ? -1 : 1;
				let candidate = adapter.addDays(adapter.date(curId), calendarDays);
				while (!props.weekdays.includes(adapter.toJsDate(candidate).getDay())) candidate = adapter.addDays(candidate, step);
		...
		function onEscape() {
			...
			if (daysInMonth.value.find((d) => d.isoDate === targetIso && !d.isAdjacent)) {
				focusItem(targetIso);
				return;
			}
		...
		function onDayClick(item) {
			if (item.isAdjacent) onDaySelect(item.isoDate);
			else selectItem(item.isoDate);
		}
		function focusGrid() {
		...
		useRender(() => createBaseVNode("div", {
		...
		}, [createTextVNode("\xA0")]), weekNumbers.value.map((week) => createBaseVNode("div", { "class": normalizeClass(["v-date-picker-month__day", "v-date-picker-month__day--adjacent"]) }, [week]))]), createVNode(MaybeTransition, { "name": transition.value }, { default: () => [createBaseVNode("div", mergeProps({
			"key": daysInMonth.value[0].date?.toString(),
			"class": "v-date-picker-month__days",
			"role": "grid",
			"onMouseleave": range.clearPreview
		}, containerProps.value), [!props.hideWeekdays && createBaseVNode("div", {
			"key": "weekday-labels",
			"class": "v-date-picker-month__days-row"
		}, [weekdayLabels.value.map((weekDay) => createBaseVNode("div", { "class": normalizeClass(["v-date-picker-month__day", "v-date-picker-month__weekday"]) }, [weekDay]))]), dayRows.value.map((row, rowIndex) => createBaseVNode("div", {
			"class": "v-date-picker-month__days-row",
			"role": "row"
			...
			const slotProps = {
				props: {
					...
					color: isSelected && !rangeMiddle || item.isToday ? props.color : void 0,
					disabled,
					readonly: props.readonly,
					icon: true,
					ripple: false,
					...
					"data-v-date": !disabled ? item.isoDate : void 0,
					onMousedown: (e) => e.preventDefault(),
			...
			return createBaseVNode("div", {
				...
				"role": "gridcell"
			}, [(hasRangeBg || hasPreviewBg) && createBaseVNode("div", {
				"key": "range-bg",
				"class": normalizeClass([
				...
				"style": normalizeStyle(rangeColorStyles.value)
			}, null), (props.showAdjacentMonths || !item.isAdjacent) && (slots.day?.(slotProps) ?? createVNode(VBtn, slotProps.props, { default: () => [item.localized, genEvents(item.isoDate)] }))]);
		})]))])] })]));
		return {
			focusGrid,
			focusItem
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonths.js
...
var VDatePickerMonths = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		const { containerProps, selectItem } = useGridSelection({
			items: () => months.value,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePickerYears.js
...
var VDatePickerYears = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		const { containerProps, containerEl, selectItem } = useGridSelection({
			items: () => years.value,
			columns: () => props.columns,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDatePicker/VDatePicker.js
		...
		useRender(() => {
			...
			return createVNode(VPicker, mergeProps(pickerProps, {
				...
				default: () => createBaseVNode(Fragment, null, [createVNode(VDatePickerControls, mergeProps(datePickerControlsProps, {
					...
					"onEscape": onEscape
				}), { year: slots.year }) : createVNode(VDatePickerMonth, mergeProps({
					"ref": monthGridRef,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/dateFormat.js
var DateFormatSpec = class DateFormatSpec {
	...
	static canBeParsed(v) {
		...
		return [
			...
			"m",
			"d"
		].every((sign) => lowercase.includes(sign)) && [
			"/",
			"-",
			"."
	...
	static parse(v) {
		if (!DateFormatSpec.canBeParsed(v)) throw new Error(`[${v}] cannot be parsed into date format specification`);
		return new DateFormatSpec(v.toLowerCase().split("").filter((c, i, all) => "dmy".includes(c) && all.indexOf(c) === i).join(""), [
			"/",
			"-",
			"."
		].find((sign) => v.includes(sign)));
	}
};
var makeDateFormatProps = propsFactory({ inputFormat: {
	type: String,
...
function useDateFormat(props, locale) {
	...
	function parseDate(dateString) {
		...
		const validatedParts = validateDateParts(parseDateParts(dateString));
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VDateInput/VDateInput.js
var makeVDateInputProps = propsFactory({
	...
	...makeDisplayProps({ mobile: null }),
	...makeFocusProps(),
	...makeVConfirmEditProps({ hideActions: true }),
	...makeVTextFieldProps({ prependIcon: "$calendar" }),
...
var VDateInput = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		function format(date) {
			if (typeof props.displayFormat === "function") return props.displayFormat(date);
			if (props.displayFormat) return adapter.format(date, props.displayFormat ?? "keyboardDate");
			return formatDate(date);
		}
		const display = computed(() => {
			const value = wrapInArray(model.value);
			if (!value.length) return null;
			if (props.multiple === true) return t("$vuetify.datePicker.itemsSelected", value.length);
		...
		function onKeydown(e) {
			...
			if (props.updateOn.includes("enter") && !props.readonly) onUserInput(e.target);
		}
		function onClick(e) {
			if (props.disabled) return;
			e.preventDefault();
			e.stopPropagation();
			if (menu.value && mobile.value) isEditingInput.value = !props.readonly;
		...
		function onBlur(e) {
			if (props.updateOn.includes("blur") && !props.readonly) onUserInput(e.target);
		...
		function onUserInput({ value }) {
			if (!value.trim()) model.value = emptyModelValue();
			else if (!props.multiple) {
				if (isValid(value)) model.value = clampDate(parseDate(value));
			} else {
				const parts = value.trim().split(/\D+-\D+|[^\d\-/.]+/);
				if (parts.every(isValid)) if (props.multiple === "range") {
					const [start, stop] = parts.map(parseDate).map(clampDate).toSorted((a, b) => adapter.isAfter(a, b) ? 1 : -1);
					model.value = createDateRange(adapter, start, stop);
				} else model.value = parts.map(parseDate).filter(isInAllowedRange);
			}
		}
		useRender(() => {
			...
			const datePickerSlots = pick(slots, [
				"title",
				"header",
				"day",
				"month",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VEmptyState/VEmptyState.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VExpansionPanel/shared.js
var VExpansionPanelSymbol = Symbol.for("vuetify:v-expansion-panel");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanelText.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanelTitle.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanel.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanels.js
var allowedVariants = [
	"default",
	"accordion",
	"inset",
...
var VExpansionPanels = genericComponent()({
	...
	setup(props, { slots }) {
		...
		const innerRounded = toRef(() => Array.isArray(props.rounded) ? props.rounded[1] : void 0);
		...
		useRender(() => createVNode(props.tag, {
			...
			"style": normalizeStyle([
				roundedStyles.value,
				{
					...
					gap: props.gap ? convertToUnit(props.gap) : void 0
				},
				props.style
			])
		}, { default: () => [slots.default?.({
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFab/VFab.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/fileDrop.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/fileFilter.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileInput/VFileInput.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileUpload/VFileUploadItem.js
...
var VFileUploadItem = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		useRender(() => {
			return createVNode(VListItem, mergeProps(VListItem.filterProps(props), {
				...
				prepend: (slotProps) => createBaseVNode(Fragment, null, [!slots.prepend ? createVNode(VAvatar, {
					...
					"image": preview.value,
					"rounded": true
				}, null) : createVNode(VDefaultsProvider, { "defaults": { VAvatar: {
					image: preview.value,
				...
				}, null) : createVNode(VDefaultsProvider, { "defaults": { VBtn: {
					icon: "$clear",
					density: "comfortable",
					variant: "text"
				} } }, { default: () => [slots.clear?.({
				...
				}) ?? createVNode(VBtn, null, null)] })]), slots.append?.(slotProps)])
			});
		});
	}
});
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileUpload/fileKey.js
var nextId = 0;
var fileIds = /* @__PURE__ */ new WeakMap();
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileUpload/VFileUploadDropzone.js
var VFileUploadKey = Symbol.for("vuetify:file-upload");
var makeVFileUploadDropzoneProps = propsFactory({
	browseText: {
		type: String,
	...
	...makeDelayProps(),
	...makeDensityProps(),
	...pick(makeVDividerProps({ length: 150 }), [
		"length",
		"thickness",
		"opacity"
	]),
...
var VFileUploadDropzone = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		async function onDrop(e) {
			...
			const files = await handleDrop(e);
			if (context) context.onDrop(files);
			else emit("drop", files);
		}
		function onClickBrowse() {
			if (!isInteractive.value) return;
			if (context) context.onClickBrowse();
			else emit("click:browse");
		}
		function onKeydown(e) {
			if (!isInteractive.value) return;
		...
		function onClickRemove(index) {
			if (!isInteractive.value) return;
			if (context) context.onClickRemove(index);
			else emit("click:remove", index);
		}
		async function onPaste(e) {
			if (!isInteractive.value || !hasFilesOrFolders(e)) return;
			e.preventDefault();
		...
		useRender(() => {
			...
			return createVNode(VSheet, mergeProps({
				...
				"onDrop": onDrop,
				"onPaste": onPaste,
				"onClick": !hasBrowse && !(isInset && hasFiles) ? onClickBrowse : void 0,
				"onKeydown": onKeydown
			}), { default: () => [
				slots.default?.({
					...
					}) ?? createVNode(VDefaultsProvider, { "defaults": { VFileUploadItem: {
						file: modelValue[0],
						clearable: props.clearable && !readonly,
						disabled,
						showSize: props.showSize,
						border: false
					} } }, { default: () => [createVNode(VFileUploadItem, { "onClick:remove": () => onClickRemove(0) }, null)] }) : modelValue.map((file, i) => {
						const key = getFileKey(file);
						const slotProps = {
							file,
							props: { "onClick:remove": () => onClickRemove(i) }
						};
						return createVNode(VDefaultsProvider, {
							"key": key,
							"defaults": { VFileUploadItem: {
								file,
								clearable: props.clearable && !readonly,
								disabled,
								showSize: props.showSize,
					...
					createBaseVNode("div", { "class": "v-file-upload-inset__action" }, [!slots.browse ? createVNode(VBtn, {
						...
						text: t(props.browseText),
						variant: "text"
					} } }, { default: () => [slots.browse({ props: { onClick: onClickBrowse } })] })])
				]) : createBaseVNode(Fragment, null, [
					hasIcon && createBaseVNode("div", {
						"key": "icon",
					...
					props.density === "default" && createBaseVNode(Fragment, null, [hasBrowse && createBaseVNode(Fragment, null, [createBaseVNode("div", {
						"key": "upload-divider",
						"class": "v-file-upload-divider"
					}, [slots.divider?.() ?? createVNode(VDivider, dividerProps, { default: () => [t(props.dividerText)] })]), !slots.browse ? createVNode(VBtn, {
						"readonly": !interactive,
						"size": "large",
						"text": t(props.browseText),
						"variant": "tonal",
						...
						text: t(props.browseText),
						variant: "tonal"
					} } }, { default: () => [slots.browse({ props: { onClick: onClickBrowse } })] })]), props.subtitle && createBaseVNode("div", { "class": "v-file-upload-subtitle" }, [props.subtitle])])
				])),
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileUpload/VFileUploadList.js
var makeVFileUploadListProps = propsFactory({
	clearable: Boolean,
	showSize: Boolean,
	files: Array,
	...makeVListProps({
...
var VFileUploadList = genericComponent()({
	...
	setup(props, { slots }) {
		...
		useRender(() => {
			...
			if (!slots.default && !files.length) return createBaseVNode(Fragment, null, null);
			return createVNode(VList, mergeProps(listProps, {
				"disabled": disabled,
				...
				const slotProps = {
					file,
					props: { "onClick:remove": () => context?.onClickRemove(index) }
				};
				return createVNode(VDefaultsProvider, {
					"key": key,
					"defaults": { VFileUploadItem: {
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFileUpload/VFileUpload.js
...
var VFileUpload = genericComponent()({
	...
	setup(props, { attrs, emit, slots }) {
		...
		function onFileSelection(e) {
			...
			if (!props.filterByType) model.value = props.multiple ? [...model.value, ...selectedFiles] : selectedFiles;
			else selectAccepted(selectedFiles);
		}
		function selectAccepted(files) {
			const dataTransfer = new DataTransfer();
			const { accepted, rejected } = filterAccepted(files);
		...
		useRender(() => {
			const { modelValue: _, ...inputProps } = VInput.filterProps(props);
			const { modelValue: __, ...dropzoneProps } = VFileUploadDropzone.filterProps(props);
			const [rootAttrs, inputAttrs] = filterInputAttrs(attrs);
			const expectsDirectory = attrs.webkitdirectory !== void 0 && attrs.webkitdirectory !== false;
			const acceptFallback = attrs.accept ? String(attrs.accept) : void 0;
			const inputAccept = expectsDirectory ? void 0 : props.filterByType ?? acceptFallback;
			...
			return createVNode(VInput, mergeProps({
				...
				"modelValue": props.multiple ? model.value : model.value[0],
				"onUpdate:modelValue": (val) => {
					if (val == null || Array.isArray(val) && !val.length) model.value = [];
				},
				"class": [
					"v-file-upload",
					loaderClasses.value,
				...
				...slots,
				default: () => {
					return createBaseVNode(Fragment, null, [slots.default ? createBaseVNode(Fragment, null, [slots.default(), createBaseVNode("input", mergeProps({
						"ref": inputRef,
						"type": "file",
						"accept": inputAccept,
						"disabled": props.disabled ?? void 0,
						...
						"style": "display: none;",
						"onChange": onFileSelection
					}, inputAttrs), null)]) : createVNode(VFileUploadDropzone, mergeProps({ "ref": vDropzoneRef }, dropzoneProps), {
						browse: slots.browse,
						icon: slots.icon,
						title: slots.title,
						...
						loader: () => createVNode(LoaderSlot, {
							"name": "v-file-upload",
							"active": !!props.loading,
							"color": loadingColor.value
						}, { default: slots.loader })
					}), !slots.default && !props.insetFileList && createVNode(VDefaultsProvider, { "defaults": { VFileUploadList: {
						clearable: props.clearable,
						showSize: props.showSize
					} } }, { default: () => [createVNode(VFileUploadList, null, { item: slots.item })] })]);
				}
			});
		});
		return forwardRefs({ controlRef: inputRef }, vInputRef, vDropzoneRef);
	}
});
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VFooter/VFooter.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VForm/VForm.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VKbd/VKbd.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VHotkey/VHotkey.js
	...
	setup(props) {
		...
		function renderKey(key, keyIndex) {
			...
			return createVNode(isContained ? "kbd" : VKbd, {
				...
				"style": normalizeStyle(isContained ? void 0 : [colorStyles.value, roundedStyles.value]),
				"aria-hidden": "true",
		...
		useRender(() => {
			...
			return createBaseVNode("div", {
				...
				"style": normalizeStyle([colorStyles.value, roundedStyles.value]),
				"aria-hidden": "true"
			}, { default: () => [content] })]);
		});
	}
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VHover/VHover.js
...
var VHover = genericComponent()({
	...
	setup(props, { slots }) {
		...
		watch(() => props.disabled, (val, old) => {
			if (old && !val) isHovering.value = internal.value;
		});
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VInfiniteScroll/VInfiniteScroll.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VItemGroup/VItemGroup.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VItemGroup/VItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VLayout/VLayout.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VLayout/VLayoutItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VLazy/VLazy.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VLocaleProvider/VLocaleProvider.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VNavigationDrawer/sticky.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/touch.js
var HORIZON = 100;
var HISTORY = 20;
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VNavigationDrawer/touch.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VNavigationDrawer/VNavigationDrawer.js
var locations = [
	"start",
	"end",
	"left",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VNoSsr/VNoSsr.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VOtpInput/shared.js
var VOtpInputSymbol = Symbol.for("vuetify:v-otp-input");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VOtpInput/VOtpField.js
var makeVOtpFieldProps = propsFactory({ index: {
	type: Number,
	required: true
} }, "VOtpField");
var VOtpField = genericComponent()({
	name: "VOtpField",
	props: makeVOtpFieldProps(),
	setup(props) {
		const otpInput = inject(VOtpInputSymbol);
		if (!otpInput) throw new Error("[Vuetify] VOtpField must be used inside VOtpInput");
		...
		useRender(() => {
			if (!slot.value) return createBaseVNode(Fragment, null, null);
			return createVNode(VField, {
				"focused": slot.value.isActive || isHighlighted.value,
				"class": normalizeClass({ "v-otp-input__field--highlighted": isHighlighted.value }),
				"onMousedown": (e) => e.preventDefault(),
				"onClick": () => otpInput.focusAt(props.index)
			}, {
				loader: void 0,
				default: () => createBaseVNode("div", { "class": "v-otp-input__field" }, [createBaseVNode("input", {
					"class": "v-otp-input__spacer",
					"aria-hidden": "true",
					"tabindex": "-1"
				}, null), slot.value.compositionChar ? createBaseVNode("span", { "class": "v-otp-input__composition" }, [slot.value.compositionChar]) : slot.value.hasFakeCaret ? createBaseVNode("span", { "class": "v-otp-input__caret" }, null) : createBaseVNode("span", { "class": normalizeClass(!slot.value.char ? "v-otp-input__placeholder" : void 0) }, [slot.value.char ?? slot.value.placeholderChar ?? ""])])
			});
		});
	}
});
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VOtpInput/VOtpGroup.js
function countSlotChildren(vnodes) {
	let count = 0;
	for (const vnode of vnodes) if (vnode.type === Fragment && Array.isArray(vnode.children)) count += countSlotChildren(vnode.children);
	else count++;
	return count;
}
var makeVOtpGroupProps = propsFactory({ merged: {
	type: Boolean,
	default: null
} }, "VOtpGroup");
var VOtpGroup = genericComponent()({
	name: "VOtpGroup",
	...
	setup(props, { slots }) {
		...
		useRender(() => {
			...
			return createBaseVNode("div", {
				"class": normalizeClass(["v-otp-group", { "v-otp-group--merged": isMerged.value }]),
				"style": normalizeStyle(isMerged.value ? { flex: countSlotChildren(children) } : void 0)
			}, [children]);
		});
	}
});
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VOtpInput/VOtpSeparator.js
var VOtpSeparator = createSimpleFunctional("v-otp-input__divider");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VOtpInput/useOtpInput.js
var OtpInputPatterns = {
	numeric: /[0-9]/,
	alpha: /[a-zA-Z]/,
...
var IME_SCRIPT_RE = /[\p{Script=Han}\p{Script=Hiragana}\p{Script=Katakana}\p{Script=Hangul}\p{Script=Bopomofo}]/u;
var graphemeSegmenter = /* @__PURE__ */ new Intl.Segmenter(void 0, { granularity: "grapheme" });
function useOtpInput(options) {
	const { value, length: _length = 6, pattern, type = "number", masked = false, placeholder, isFocused = shallowRef(false) } = options;
	...
	const slots = computed(() => {
		...
		return Array.from({ length: length.value }, (_, i) => {
			...
			if (composition.value && i >= compositionStart) {
				const c = compositionChars[i - compositionStart];
	...
	function insert(text, range) {
		...
		setSelection(graphemeIndexToCodeUnits(next, Math.min(insertEndG, length.value - 1)), insertEnd, "forward");
		return next;
	}
	function deleteRange(start, end) {
		...
		value.value = next;
		setSelection(start, Math.min(start + 1, next.length), "forward");
		return next;
	}
	...
	function selectSlot(index) {
		...
		const next = {
			start: graphemeIndexToCodeUnits(current, clamped),
			end: clamped < graphemeCount ? graphemeIndexToCodeUnits(current, clamped + 1) : current.length,
			direction: "forward"
		};
		selection.value = next;
		prevSelection = next;
	...
	function extendSelection(direction) {
		...
		const next = {
			start: graphemeIndexToCodeUnits(current, minG),
			end: maxG + 1 >= valueG ? current.length : graphemeIndexToCodeUnits(current, maxG + 1),
			direction: newFocus < anchorG ? "backward" : "forward"
		};
		selection.value = next;
		prevSelection = next;
		return next;
	...
	function syncSelection(raw) {
		...
		let direction;
		if (valueG !== 0) {
			if (startG === endG && !(startG === valueG && valueG < maxLength)) {
				if (startG === 0) {
					outStartG = 0;
					outEndG = 1;
					direction = "forward";
					...
					if (prevSelection !== null) {
						...
						if (direction === "backward" && !wasPreviouslyInserting && !wasMultiSlot) offset = -1;
					}
		...
		const next = {
			start: graphemeIndexToCodeUnits(inputValue, finalStartG),
			end: graphemeIndexToCodeUnits(inputValue, finalEndG),
			direction: direction ?? selectionDirection ?? "none"
		};
		selection.value = next;
		prevSelection = next;
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VOtpInput/VOtpInput.js
...
var VOtpInput = genericComponent()({
	...
	setup(props, { attrs, emit, slots }) {
		...
		function onSelectionChange() {
			...
			if (!result) return;
			if (input.selectionStart !== result.start || input.selectionEnd !== result.end) input.setSelectionRange(result.start, result.end, result.direction);
		}
		function onInput(e) {
			const ev = e;
			const target = e.target;
			if ((ev.isComposing || otp.isComposing.value) && otp.isImeText(target.value)) return;
		...
		useRender(() => {
			...
			return createBaseVNode("div", mergeProps({
				...
				slots.fields ? slots.fields() : props.merged ? createVNode(VOtpGroup, { "merged": true }, { default: () => [Array.from({ length: length.value }, (_, i) => createVNode(VOtpField, {
					"index": i,
					"key": i
				}, null))] }) : Array.from({ length: length.value }, (_, i) => createBaseVNode(Fragment, null, [(props.divider || slots.divider) && i !== 0 && createVNode(VOtpSeparator, { "key": `d-${i}` }, { default: () => [slots.divider?.({ index: i - 1 }) ?? props.divider] }), createVNode(VOtpField, {
					"index": i,
					"key": i
				}, null)])),
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VParallax/VParallax.js
function floor(val) {
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VPullToRefresh/VPullToRefresh.js
var VPullToRefresh = genericComponent()({
	...
	setup(props, { slots, emit }) {
		...
		function onTouchmove(e) {
			...
			if (scrollParents.length && !scrollParents[0].scrollTop) touchDiff.value = touchY - touchstartY;
		}
		function onTouchend(e) {
			if (refreshing.value || props.disabled) return;
		...
		useRender(() => {
			return createBaseVNode("div", {
				...
				"class": normalizeClass(["v-pull-to-refresh__pull-down", { "v-pull-to-refresh__pull-down--touching": touching.value }]),
				"style": {
			...
			}) : createBaseVNode("div", { "class": normalizeClass(["v-pull-to-refresh__pull-down-default"]) }, [refreshing.value ? createVNode(VProgressCircular, {
				"indeterminate": true,
				"active": false
			}, null) : createVNode(VIcon, { "icon": canRefresh.value || goingUp.value ? "$sortAsc" : "$sortDesc" }, null)])]), createBaseVNode("div", {
				"class": normalizeClass(["v-pull-to-refresh__scroll-container", { "v-pull-to-refresh__scroll-container--touching": touching.value }]),
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VRadio/VRadio.js
var makeVRadioProps = propsFactory({ ...omit(makeVSelectionControlProps({
	falseIcon: "$radioOff",
	trueIcon: "$radioOn"
}), ["indeterminate", "indeterminateIcon"]) }, "VRadio");
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VRadioGroup/VRadioGroup.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VRangeSlider/VRangeSlider.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VRating/VRating.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSkeletonLoader/VSkeletonLoader.js
var rootTypes = {
	actions: "button@2",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSlideGroup/VSlideGroupItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSnackbarQueue/queue.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSnackbar/VSnackbar.js
...
var makeVSnackbarProps = propsFactory({
	...
	vertical: Boolean,
	...makeLocationProps({ location: "bottom center" }),
	...makePositionProps(),
	...makeRoundedProps(),
	...makeVariantProps(),
	...makeThemeProps(),
		...
		useRender(() => {
			...
			return createVNode(VOverlay, mergeProps({
				...
				default: () => [
					...
					props.timer && Number(props.timeout) > 0 && !isHovering.value && createBaseVNode("div", {
						"key": "timer",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/composables/documentVisibility.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSnackbarQueue/VSnackbarQueue.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTooltip/VTooltip.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSparkline/VSparklineTooltip.js
var makeVSparklineTooltipProps = propsFactory({
	modelValue: Boolean,
	target: Object,
	index: {
		type: Number,
...
var VSparklineTooltip = genericComponent()({
	name: "VSparklineTooltip",
	props: makeVSparklineTooltipProps(),
	emits: { afterLeave: () => true },
	setup(props, { slots, emit }) {
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSparkline/util/monotone.js
/**
...
*/
function genMonotonePath(points, smooth, fill = false, height = 75) {
	...
	if (smooth === 0 || points.length < 3) return prefix + points.slice(1).map((point) => `L${point.x} ${point.y}`).join("") + suffix;
	...
	for (let i = 1; i < n - 1; i++) if (delta[i - 1] === 0 || delta[i] === 0 || delta[i - 1] > 0 !== delta[i] > 0) tangent[i] = 0;
	else tangent[i] = (delta[i - 1] + delta[i]) / 2;
	for (let i = 0; i < n - 1; i++) if (delta[i] === 0) {
		tangent[i] = 0;
		tangent[i + 1] = 0;
	} else {
	...
	return prefix + points.slice(1).map((curr, index) => {
		const prev = points[index];
		const dx = curr.x - prev.x;
		return `C${prev.x + dx * tension / 3} ${prev.y + tangent[index] * dx * tension / 3} ${curr.x - dx * tension / 3} ${curr.y - tangent[index + 1] * dx * tension / 3} ${curr.x} ${curr.y}`;
	}).join("") + suffix;
}
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSparkline/util/path.js
/**
* From https://github.com/unsplash/react-trend/blob/master/src/helpers/DOM.helpers.js#L18
*/
function genRoundedPath(points, radius, fill = false, height = 75, consistentStructure = false) {
	if (points.length === 0) return "";
	...
	return (fill ? `M${start.x} ${height - start.x + 2} L${start.x} ${start.y}` : `M${start.x} ${start.y}`) + points.map((point, index) => {
		...
		if (!next) return consistentStructure ? `L${point.x} ${point.y}S${point.x} ${point.y} ${point.x} ${point.y}` : `L${point.x} ${point.y}`;
		if (isCollinear && !consistentStructure) return `L${point.x} ${point.y}`;
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSparkline/util/line.js
...
function extendPoints(points, inset, totalWidth) {
...
function buildPath(points, options) {
	...
	if (options.smoothMode === "monotone") return genMonotonePath(copy, smoothValue, options.fill, options.height);
	return genRoundedPath(copy, smoothValue, options.fill, options.height, options.animation);
}
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSparkline/VBarline.js
...
var VBarline = genericComponent()({
	...
	emits: { "update:currentIndex": (_index) => true },
	setup(props, { slots, attrs, emit }) {
		const uid = useId();
		...
		watch(() => props.modelValue, async () => {
			...
			clipRects.value.forEach((el, i) => {
				...
				if (shouldDrawOnce && props.animation) el.addEventListener("transitionend", () => {
		...
		const tooltipTarget = computed(() => {
			if (currentIndex.value === null || !svgRef.value) return void 0;
			const ctm = svgRef.value.getScreenCTM();
			if (!ctm) return void 0;
		...
		function onSvgBlur() {
			tooltipVisible.value = false;
			if (!props.tooltip) setIndex(null);
		}
		function onSvgKeydown(e) {
			...
			if (e.key === "ArrowLeft" || e.key === "ArrowRight") {
				...
				setIndex(Math.max(0, Math.min(len - 1, current + direction)));
			}
		}
		useRender(() => {
			const gradientData = !props.gradient.slice().length ? [""] : props.gradient.slice().reverse();
			return createBaseVNode(Fragment, null, [createBaseVNode("svg", mergeProps({
				"ref": svgRef,
				"display": "block",
				"tabindex": props.interactive ? 0 : void 0,
				"onMousemove": props.interactive ? onSvgMousemove : void 0,
				"onMouseleave": props.interactive ? onSvgMouseleave : void 0,
				"onFocus": props.interactive ? onSvgFocus : void 0,
				"onBlur": props.interactive ? onSvgBlur : void 0,
				"onKeydown": props.interactive ? onSvgKeydown : void 0
			}, attrs), [
				...
				createBaseVNode("clipPath", { "id": `${id.value}-clip` }, [bars.value.map((item, i) => createBaseVNode("rect", {
					"ref": (el) => {
				...
				props.interactive && currentIndex.value !== null && createBaseVNode("rect", {
					"key": "highlight",
			...
			]), !!props.tooltip && createVNode(VSparklineTooltip, {
				"key": "tooltip",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSparkline/VTrendline.js
...
var VTrendline = genericComponent()({
	...
	setup(props, { slots, attrs, emit }) {
		...
		const normalizedItems = computed(() => {
			if (!props.animation || !sampleCount.value || items.value.length === sampleCount.value) return items.value;
		...
		function genPath(input, fill) {
			return buildPath(typeof input[0] === "number" ? extendPoints(genPoints(input, boundary.value), props.inset, totalWidth.value) : input, {
				smooth: props.smooth,
		...
		watch(() => props.modelValue, async () => {
			...
			if (!props.autoDraw) {
				if (props.animation && strokePath.value) {
					for (const path of [fillPath.value, strokePath.value]) if (path) applyDTransition(path, animationDuration.value, animationEasing.value);
				}
				return;
			}
			...
			if (!props.fill) {
				...
				if (shouldDrawOnce) path.addEventListener("transitionend", (e) => {
					if (e.propertyName !== "stroke-dashoffset") return;
					path.style.strokeDasharray = "";
					path.style.strokeDashoffset = "";
					if (props.animation) applyDTransition(path, animationDuration.value, animationEasing.value);
					else path.style.transition = "";
				}, { once: true });
			} else for (const path of [fillPath.value, strokePath.value]) {
				if (!path) continue;
		...
		const markerPoint = computed(() => {
			const { x, y } = strokePath.value?.getPointAtLength(animatedLength.value) ?? {
				x: 0,
				y: 0
			};
			return {
		...
		const tooltipTarget = computed(() => {
			if (!currentPoint.value || !svgRef.value) return void 0;
		...
		function onSvgKeydown(e) {
			...
			if (e.key === "ArrowLeft" || e.key === "ArrowRight") {
				...
				setIndex(Math.max(0, Math.min(length - 1, current + direction)));
			}
		}
		useRender(() => {
			const gradientData = !props.gradient.slice().length ? [""] : props.gradient.slice().reverse();
			...
			return createBaseVNode(Fragment, null, [createBaseVNode("svg", mergeProps({
				...
				props.showMarkers && createBaseVNode("g", { "key": "markers" }, [points.value.map((point, i) => createBaseVNode("circle", {
					"key": i,
					"cx": point.x,
					"cy": point.y,
					"r": markerRadius,
				...
				props.interactive && currentPoint.value && createBaseVNode("g", {
					"key": "hover",
					"pointer-events": "none"
				}, [tooltipConfig.value.showCrosshair && createBaseVNode("line", {
					"key": "crosshair-line",
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSparkline/VSparkline.js
...
var VSparkline = genericComponent()({
	...
	setup(props, { slots, emit }) {
		...
		useRender(() => {
			...
			}, lineProps, { "onUpdate:currentIndex": (v) => emit("update:currentIndex", v) }), slots);
		});
	}
});
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSpeedDial/VSpeedDial.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/shared.js
var VStepperSymbol = Symbol.for("vuetify:v-stepper");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepperActions.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepperHeader.js
var VStepperHeader = createSimpleFunctional("v-stepper-header");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepperItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepperWindow.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepperWindowItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepper/VStepper.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepperVertical/VStepperVerticalActions.js
var makeVStepperVerticalActionsProps = propsFactory({ ...makeVStepperActionsProps() }, "VStepperActions");
var VStepperVerticalActions = genericComponent()({
	...
	setup(props, { emit, slots }) {
		...
		useRender(() => {
			return createVNode(VStepperActions, mergeProps({ "class": "v-stepper-vertical-actions" }, VStepperActions.filterProps(props), {
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepperVertical/VStepperVerticalItem.js
		...
		useRender(() => {
			...
			return createVNode(VExpansionPanel, mergeProps({
				...
				title: () => createBaseVNode(Fragment, null, [createVNode(VAvatar, {
					...
					"size": 24,
					"start": true
				}, { default: () => [slots.icon?.(slotProps.value) ?? (icon.value ? createVNode(VIcon, { "icon": icon.value }, null) : step.value)] }), createBaseVNode("div", null, [createBaseVNode("div", { "class": "v-stepper-vertical-item__title" }, [slots.title?.(slotProps.value) ?? props.title]), createBaseVNode("div", { "class": "v-stepper-vertical-item__subtitle" }, [slots.subtitle?.(slotProps.value) ?? props.subtitle])])]),
				text: () => createBaseVNode(Fragment, null, [slots.default?.(slotProps.value) ?? props.text, hasActions && createVNode(VDefaultsProvider, { "defaults": { VStepperVerticalActions: {
					disabled: disabled.value,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VStepperVertical/VStepperVertical.js
...
var VStepperVertical = genericComponent()({
	...
	setup(props, { slots }) {
		...
		useRender(() => {
			return createVNode(VExpansionPanels, mergeProps(VExpansionPanels.filterProps(props), {
				"modelValue": model.value,
				"onUpdate:modelValue": ($event) => model.value = $event,
				...
				...slots,
				default: ({ prev, next }) => {
					return createBaseVNode(Fragment, null, [items.value.map(({ raw, ...item }) => createVNode(VStepperVerticalItem, item.props, {
						...slots,
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSwitch/VSwitch.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VSystemBar/VSystemBar.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTabs/shared.js
var VTabsSymbol = Symbol.for("vuetify:v-tabs");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTabs/VTab.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTabs/VTabsWindow.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTabs/VTabsWindowItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTabs/VTabs.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTextarea/VTextarea.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VThemeProvider/VThemeProvider.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimeline/VTimelineDivider.js
	...
	setup(props, { slots }) {
		...
		useRender(() => createBaseVNode("div", {
			...
			!props.hideDot && createBaseVNode("div", {
				...
				"style": normalizeStyle([sizeStyles.value, roundedStyles.value])
			}, [createBaseVNode("div", {
				"class": normalizeClass([
				...
				"style": normalizeStyle([backgroundColorStyles.value, roundedStyles.value])
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimeline/VTimelineItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimeline/VTimeline.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/VTimePickerClock.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/VTimePickerField.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/util.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/useTimeValidation.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/VTimePickerControls.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTimePicker/VTimePicker.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VToolbar/VToolbarItems.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTreeview/VTreeviewGroup.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTreeview/shared.js
var VTreeviewSymbol = Symbol.for("vuetify:v-treeview");
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTreeview/VTreeviewItem.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTreeview/VTreeviewChildren.js
			...
			return children ? createVNode(VTreeviewGroup, mergeProps(treeviewGroupProps, {
				...
				activator: ({ props: activatorProps, isOpen }) => {
					const listItemProps = {
						...
						onClick: props.disabled || treeItemProps.disabled ? void 0 : isClickOnOpen.value ? [() => checkChildren(item), activatorProps.onClick] : () => selectItem(activatorItems.value[index]?.select, !activatorItems.value[index]?.isSelected)
					};
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VTreeview/VTreeview.js
...
//#endregion
//#region node_modules/.pnpm/vuetify@4.1.2_typescript@5.9.3_vite-plugin-vuetify@2.1.3_vue@3.5.39_typescript@5.9.3_/node_modules/vuetify/lib/components/VValidation/VValidation.js
...
//#endregion
export { VAlert, VAlertTitle, VApp, VAppBar, VAppBarNavIcon, VAppBarTitle, VAutocomplete, VAvatar, VBadge, VBanner, VBannerActions, VBannerText, VBottomNavigation, VBottomSheet, VBreadcrumbs, VBreadcrumbsDivider, VBreadcrumbsItem, VBtn, VBtnGroup, VBtnToggle, VCalendar, VCard, VCardActions, VCardItem, VCardSubtitle, VCardText, VCardTitle, VCarousel, VCarouselItem, VCheckbox, VCheckboxBtn, VChip, VChipGroup, VClassIcon, VCode, VCol, VColorInput, VColorPicker, VCombobox, VComponentIcon, VConfirmEdit, VContainer, VCounter, VDataIterator, VDataTable, VDataTableFooter, VDataTableHeaders, VDataTableRow, VDataTableRows, VDataTableServer, VDataTableVirtual, VDateInput, VDatePicker, VDatePickerControls, VDatePickerHeader, VDatePickerMonth, VDatePickerMonths, VDatePickerYears, VDefaultsProvider, VDialog, VDialogBottomTransition, VDialogTopTransition, VDialogTransition, VDivider, VEmptyState, VExpandBothTransition, VExpandTransition, VExpandXTransition, VExpansionPanel, VExpansionPanelText, VExpansionPanelTitle, VExpansionPanels, VFab, VFabTransition, VFadeTransition, VField, VFieldLabel, VFileInput, VFileUpload, VFileUploadDropzone, VFileUploadItem, VFileUploadList, VFooter, VForm, VHotkey, VHover, VIcon, VIconBtn, VImg, VInfiniteScroll, VInput, VItem, VItemGroup, VKbd, VLabel, VLayout, VLayoutItem, VLazy, VLigatureIcon, VList, VListGroup, VListImg, VListItem, VListItemAction, VListItemMedia, VListItemSubtitle, VListItemTitle, VListSubheader, VLocaleProvider, VMain, VMenu, VMessages, VNavigationDrawer, VNoSsr, VNumberInput, VOtpField, VOtpGroup, VOtpInput, VOtpSeparator, VOverlay, VPagination, VParallax, VPicker, VPickerTitle, VProgressCircular, VProgressLinear, VPullToRefresh, VRadio, VRadioGroup, VRangeSlider, VRating, VResponsive, VRow, VScaleTransition, VScrollXReverseTransition, VScrollXTransition, VScrollYReverseTransition, VScrollYTransition, VSelect, VSelectionControl, VSelectionControlGroup, VSheet, VSkeletonLoader, VSlideGroup, VSlideGroupItem, VSlideXReverseTransition, VSlideXTransition, VSlideYReverseTransition, VSlideYTransition, VSlider, VSnackbar, VSnackbarQueue, VSpacer, VSparkline, VSparklineTooltip, VSpeedDial, VStepper, VStepperActions, VStepperHeader, VStepperItem, VStepperVertical, VStepperVerticalActions, VStepperVerticalItem, VStepperWindow, VStepperWindowItem, VSvgIcon, VSwitch, VSystemBar, VTab, VTable, VTabs, VTabsWindow, VTabsWindowItem, VTextField, VTextarea, VThemeProvider, VTimePicker, VTimePickerClock, VTimePickerControls, VTimeline, VTimelineItem, VToolbar, VToolbarItems, VToolbarTitle, VTooltip, VTreeview, VTreeviewGroup, VTreeviewItem, VValidation, VVirtualScroll, VWindow, VWindowItem };
